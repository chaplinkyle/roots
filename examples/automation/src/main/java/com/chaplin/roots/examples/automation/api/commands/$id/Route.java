package com.chaplin.roots.examples.automation.api.commands.$id;
...
public final class Route implements ApiRoute {
    ...
    @Override public Response get(Request request) throws Exception { return inbox.status(request); }
}
