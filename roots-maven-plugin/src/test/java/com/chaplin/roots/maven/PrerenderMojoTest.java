package com.chaplin.roots.maven;
...
final class PrerenderMojoTest {
    ...
    void generatesApplicationResourcesThroughThePluginBoundary() throws Exception {
        ...
        mojo.applicationClass = com.chaplin.roots.maven.fixture.Application.class.getName();
        ...
        assertTrue(Files.isRegularFile(temporaryDirectory.resolve(
                "META-INF/roots/prerender/com.chaplin.roots.maven.fixture.Application.index")));
    }
    ...
    void rejectsMissingApplicationClassAndDevelopmentConfiguration() {
        ...
        development.applicationClass = com.chaplin.roots.maven.fixture.Application.class.getName();
    ...
    public static final class DevelopmentConfig implements com.chaplin.roots.PrerenderConfigFactory {
        @Override
        public com.chaplin.roots.RootsConfig create(Class<?> applicationClass) {
            return com.chaplin.roots.RootsConfig.forApplication(applicationClass).development(true).build();
        }
    }
}
