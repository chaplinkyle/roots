...
final class SessionRepositoryIntegrationTest {
    ...
    void runtimeUsesAPluggableRepositoryWithoutOwningSharedData() throws Exception {
        ...
        var application = Roots.start(RootsConfig.forApplication(com.chaplin.roots.manifestapp.Application.class)
                .port(0)
                .development(false)
    ...
    void repositoryAvailabilityFailuresBecomeSessionFreeServiceUnavailableResponses() throws Exception {
        try (var application = Roots.start(RootsConfig.forApplication(com.chaplin.roots.manifestapp.Application.class)
                .port(0)
                .development(false)
